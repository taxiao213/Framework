...
public class EthernetServiceImpl extends IEthernetManager.Stub {
    ...
    public void createIpConfigTxt(String iface) {
        ...
        mEthernetConfigStore.createIpConfigTxt(iface);
    }
    ...
    public IpConfiguration getConfigurationWithIFace(String ifname) {
        enforceAccessPermission();
        return mEthernetConfigStore.readIpAndProxyConfigurationsWithIFace(ifname);
    }
    ...
    public void setConfigurationWithIFace(IpConfiguration config, String ifname) {
        ...
        mEthernetConfigStore.writeIpAndProxyConfigurations(config, ifname);
        // TODO: this does not check proxy settings, gateways, etc.
        // Fix this by making IpConfiguration a complete representation of static configuration.
        mIpConfiguration = new IpConfiguration(config);
        mTracker.reconnect(ifname);
    ...
    @Override
    public int getEthernetConnectStateWithIFace(String ifname) {
        enforceAccessPermission();
        return mTracker.getEthernetConnectState(ifname);
    }
    ...
    @Override
    public String getIpAddressWithIFace(String ifname) {
        enforceAccessPermission();
    ...
    @Override
    public String getNetmaskWithIFace(String ifname) {
        enforceAccessPermission();
    ...
    @Override
    public String getGatewayWithIFace(String ifname) {
        enforceAccessPermission();
    ...
    @Override
    public String getDnsWithIFace(String ifname) {
        enforceAccessPermission();
